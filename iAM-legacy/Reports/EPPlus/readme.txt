One or more parts of RoadCare use a version of the EPPlus library that is LGPL 2.1 software.

The EPPlus DLL that is distributed with RoadCare can be replaced by the user.

ARA cannot guarantee support for any use of RoadCare after any such modification.
