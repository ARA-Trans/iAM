...
{
    public static class RestoreApplicationLocation
    {

        /// <summary>
        /// Resets the Application Geometry to the previous size
        /// </summary>
        /// <param name="thisWindowGeometry"></param>
        /// <param name="formIn">Form to remember size for</param>
        ...
        /// <summary>
        /// Checks if window is outside of bounds
        /// </summary>
        ...
        /// <summary>
        /// Checks if window is very large (for resized monitor)
        /// </summary>
        /// <param name="size"></param>
        /// <returns></returns>
