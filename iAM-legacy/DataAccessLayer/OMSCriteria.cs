...
namespace DataAccessLayer
{
    public static class OMSCriteria
    {
        ...
        private static string ParseDateCriteria(string omsDateCriteria)
        {
            ...
            {
                deDateCriteria = deDateCriteria.Replace(DATETIMEVARIABLE, dateTimeVariable.ToUpper());
                if (dateTimeValue != null)
                {
        ...
        private static string GetDateNot(string[] parts)
        {
            ...
            switch (parts[0])
            {
                case "null":
                    ...
                    deDateCriteria = DATETIMEVARIABLE + " = null ";
                    break;
                case "today":
        ...
        private static string ParseTextCriteria(string omsTextCriteria)
        {
            ...
            {
                deTextCriteria = deTextCriteria.Replace(OMSVARIABLE, textVariable.ToUpper());
                if (textValue != null)
                {
        ...
        private static string ParseNumberCriteria(string omsNumberCriteria)
        {
            ...
            {
                deNumberCriteria = deNumberCriteria.Replace(OMSVARIABLE, numberVariable.ToUpper());
            }
