...
namespace SharpMap.Layers
{
	...
	public abstract class Layer : ILayer, ICloneable
	{
        ...
        private Hashtable m_htGeoIDs;
        public Hashtable GeoIDs
        {
            get { return m_htGeoIDs; }
            set { m_htGeoIDs = value; }
        }

        private List<String> m_listLastGeoIDs;
        public List<String> LastGeoIDs
        {
            get { return m_listLastGeoIDs; }
            set { m_listLastGeoIDs = value; }
        }
