...
function remainingLifeLimitLibraryRouter(RemainingLifeLimitLibrary) {
    ...
    router.route('/GetRemainingLifeLimitLibraries')
        .get(authorizationFilter([roles.administrator]), controller.get);
    router.route('/CreateRemainingLifeLimitLibrary')
        .post(authorizationFilter([roles.administrator]), controller.post);
    router.route('/UpdateRemainingLifeLimitLibrary')
        .put(authorizationFilter([roles.administrator]), controller.put);
    router.route('/DeleteRemainingLifeLimitLibrary/:libraryId')
        .delete(authorizationFilter([roles.administrator]), controller.deleteLibrary);
