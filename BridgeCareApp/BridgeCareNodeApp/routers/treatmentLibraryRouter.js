...
function treatmentLibraryRouter(TreatmentLibrary, connectionTest) {
    ...
    router.route('/CreateTreatmentLibrary').post(authorizationFilter([roles.administrator, roles.engineer]), controller.post);
    router.route('/UpdateTreatmentLibrary').put(authorizationFilter([roles.administrator, roles.engineer]), controller.put);
    router.route('/DeleteTreatmentLibrary/:libraryId').delete(authorizationFilter([roles.administrator, roles.engineer]), controller.deleteLibrary);
