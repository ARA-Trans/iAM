...
function performanceLibraryRouter(PerformanceLibrary, connectionTest) {
    ...
    router.route('/DeletePerformanceLibrary/:performanceLibraryId')
        .delete(authorizationFilter(["PD-BAMS-Administrator", "PD-BAMS-DBEngineer"]), controller.deleteLibrary);
    router.route('/')
        .get((req, res) => {
