...
function announcementRouter(Announcement) {
    ...
    router.route('/CreateAnnouncement')
        .post(authorizationFilter(["PD-BAMS-Administrator"]), controller.post);
    router.route('/UpdateAnnouncement')
        .put(authorizationFilter(["PD-BAMS-Administrator"]), controller.put);
    router.route('/DeleteAnnouncement/:announcementId')
        .delete(authorizationFilter(["PD-BAMS-Administrator"]), controller.deleteAnnouncement);
