...
namespace BridgeCare.Services
{
    public class CostBudgetsWorkSummary
    {
        ...
        public void FillCostBudgetWorkSummarySections(ExcelWorksheet worksheet, CurrentCell currentCell, List<int> simulationYears, List<SimulationDataModel> simulationDataModels, List<InvestmentLibraryYearlyBudgetModel> yearlyBudgetModels)
        {
        ...
        private int FillTotalBudgetSection(ExcelWorksheet worksheet, CurrentCell currentCell, List<int> simulationYears, List<InvestmentLibraryYearlyBudgetModel> yearlyBudgetModels)
        {
        ...
        private int AddDetailsForTotalBudget(ExcelWorksheet worksheet, List<int> simulationYears, CurrentCell currentCell, List<InvestmentLibraryYearlyBudgetModel> yearlyBudgetModels)
        {
            int startRow, startColumn, row, column;
            bridgeWorkSummaryCommon.SetRowColumns(currentCell, out startRow, out startColumn, out row, out column);
